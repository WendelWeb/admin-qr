      ...
      <div className="relative bg-gradient-to-br from-[#0e1c26] via-[#1a3530] to-[#386E65] rounded-3xl text-white overflow-hidden shadow-2xl mb-6">
        ...
        <div className="relative px-6 sm:px-10 pt-6 sm:pt-8">
          <div className="flex items-center gap-2">
            ...
            <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-white/60">Dashboard · Staff</div>
          </div>
        </div>

        <div className="relative px-6 sm:px-10 py-6 sm:py-8">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight">Staff Management</h1>
          <p className="text-sm sm:text-base text-white/65 mt-2 max-w-xl">
            Add, edit, and remove the physicians and officers who appear on certificates.
          </p>
        </div>

        <div className="relative px-6 sm:px-10 pb-6 sm:pb-8 grid grid-cols-2 gap-3 sm:gap-4">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-widest text-white/50">Physicians</div>
                <div className="text-2xl sm:text-3xl font-bold text-white tabular-nums mt-0.5">{physicians.length}</div>
              </div>
              <div className="w-10 h-10 rounded-xl bg-emerald-400/20 ring-1 ring-emerald-300/30 flex items-center justify-center">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-widest text-white/50">Officers</div>
                <div className="text-2xl sm:text-3xl font-bold text-white tabular-nums mt-0.5">{officers.length}</div>
              </div>
              <div className="w-10 h-10 rounded-xl bg-indigo-400/20 ring-1 ring-indigo-300/30 flex items-center justify-center">
